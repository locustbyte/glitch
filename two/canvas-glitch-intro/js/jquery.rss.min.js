(function(d) {
    ...
    e.prototype.render = function() {
        ...
        this.load(function(b) {
            ...
            0 !== b.entries.length && (d.isFunction(a.options.onData) && a.options.onData.call(a), a.appendEntriesAndApplyEffects(d("entries", b.layout), b.entries));
    ...
    e.prototype.appendEntriesAndApplyEffects = function(a, b) {
        ...
        d.each(b, function(b, e) {
            ...
            "show" === c.options.effect ? a.before(d) : (d.css({ display: "none" }),
    ...
    e.prototype.generateHTMLForEntries = function() {
        ...
        b.layout = this.options.entryTemplate ?
            this.wrapContent(this.options.layoutTemplate.replace("{entries}", "<entries></entries>")) : this.wrapContent("<div><entries></entries></div>");
        return b
    };
    e.prototype.wrapContent = function(a) { return 0 !== d.trim(a).indexOf("<") ? d("<div>" + a + "</div>") : d(a) };
    ...
    e.prototype.isRelevant = function(a, b) {
        ...
        return this.options.filter ? this.options.filterLimit && this.options.filterLimit ===
    ...
    e.prototype.getTokenMap = function(a) {
        ...
        this.formattedDate = "undefined" !== typeof moment ? moment(new Date(a.publishedDate)).format(this.options.dateFormat) : this.options.dateFormatFunction ? this.options.dateFormatFunction(a.publishedDate) : a.publishedDate;
        return d.extend({
                ...
                bodyPlain: function(a) { for (var a = a.content.replace(/<script[\\r\\\s\S]*<\/script>/mgi, "").replace(/<\/?[^>]+>/gi, ""), b = 0; b < e.htmlTags.length; b++) a = a.replace(RegExp("<" + e.htmlTags[b], "gi"), ""); return a }(a),
                shortBodyPlain: a.contentSnippet.replace(/<\/?[^>]+>/gi, ""),
                index: d.inArray(a, this.entries),
                totalEntries: this.entries.length,
                teaserImage: function(a) { try { return a.content.match(/(<img.*?>)/gi)[0] } catch (b) { return "" } }(a),
